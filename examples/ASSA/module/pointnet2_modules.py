...
from models.module.local_aggregation_operators import LocalAggregation, get_conv
...
class WeightedAvg(nn.Module):
    def __init__(self, n_samples):
        ...
        self.weights = nn.ParameterList([nn.Parameter(torch.randn((n_samples, 1)))])
...
class PointnetFPModule(nn.Module):
    ...
    def __init__(self, *, mlp: List[int], bn: bool = True, local_aggregation_cfg):
        ...
        self.convs = get_conv(conv_cfg, last_act=True)
